...
public class SearchActivity extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    private static void cramTime() {
        ...
        String[] itemIDs = {"Pizza Box", "Snickers Wrapper", "Red Bull Can", "Coke Bottle", "Cooking Oil", "Motor Oil", "TV", "Fax", "Aluminum", "Copper", "Scrap Metal", "Printer Cartridge", "leaves", "weeds", "noninvasive plants"};
    }
}
